...
public class Packager {
    ...
    [MenuItem("VivaFramework/Build WebGL Resource", false, 102)]
    ...
    public static void BuildAssetResource(BuildTarget target) {
        ...
        BuildPipeline.BuildAssetBundles(Application.streamingAssetsPath, maps.ToArray(), BuildAssetBundleOptions.ChunkBasedCompression, target);
        BuildFileIndex();
    ...
    static void HandlerDll(BuildTarget target)
    {
